...
INPUT_CORPUS = "./dataset/t5/t5_multi.txt"
OUTPUT_DIR = "./dataset/t5/mecab_tokenized"
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUTPUT_DIR, os.path.basename(INPUT_CORPUS)), "w", encoding="utf-8") as of:    
        start_time = time.time()
        print(f"start tokenization ...")
        with open(INPUT_CORPUS, "r", encoding="utf-8") as f:
            with Pool(args["n_jobs"]) as p:
                for i, result in enumerate(p.imap(tokenize_fn, f)):
